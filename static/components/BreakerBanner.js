function BreakerBanner({ state, openSince, openReason, pendingReplayCount, rapidFailures5m, onReset }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <span className="text-red-200 text-xs whitespace-nowrap">
          {pendingReplayCount || 0} replay queued • {rapidFailures5m || 0} rapid-fails/5m
        </span>
        <button
          type="button"
          onClick={onReset}
